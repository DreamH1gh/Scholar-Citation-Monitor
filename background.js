...
try {
  ...
  // 2. 提取机构信息 - 修复正则表达式
  // 匹配格式：<meta name="description" content="‪机构名称‬ - ‪‪引用次数：21 次‬‬ - ‪研究领域‬">
  ...
  console.log(`解析成功: ${name}, 引用: ${totalCitations}, H指数: ${hIndex}, i10指数: ${i10Index}`);
